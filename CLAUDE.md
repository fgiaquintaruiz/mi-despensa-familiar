...
## Rules
- **Cross-Agent Synchronization**: Any modification made to this file (`CLAUDE.md`) MUST be replicated to `GEMINI.md`. Both agents must operate with the exact same project mandates. Always use `mem_save` to record these synchronization actions in Engram.
